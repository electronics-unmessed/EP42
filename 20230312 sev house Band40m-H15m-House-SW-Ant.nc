...
// ===== Definitions ===============================================================================================================
	...
	vector v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40, v41, v42, v43, v44, v45, v46, v47, v48, v49, v50;
...
// Dipole
	...
	// Reflector 40m Band Abstimmung
	v25 = vect(-2.17 , -.60 , 0.0 ) ;	
	v26 = vect(-2.17 , .60 , 0.0 ) ;		
	
	// Director 40m Abstimmung
	v27 = vect(2.57 , -0.6 , 0.0 ) ;	
	v28 = vect(2.57 , 0.6 , 0.0 ) ;		
	...
	v34 = vect(8.0 , 17.0 , 5.0 ) ;		
		// Ecken Grundlevel kleines Haus
	v35 = vect(-12.0 , -3.0 , 0.0 ) ;	
	v36 = vect(-12.0 , 17.0 , 0.0 ) ;		
	v37 = vect(8.0 , -3.0 , 0.0 ) ;	
	v38 = vect(8.0 , 17.0 , 0.0 ) ;	
				
		// Ecken Grundlevel großes Haus
	v45 = vect(-12.0 , -3.0 , -10.0 ) ;	
	v46 = vect(-12.0 , 17.0 , -10.0 ) ;		
	v47 = vect(8.0 , -3.0 , -10.0 ) ;	
	v48 = vect(8.0 , 17.0 , -10.0 ) ;	
...
// House	0
	...
	T3 = translateTransform( vect( 0.0, 0.0, 0.5 ) ) * rotateX( 0 ) * rotateZ(0) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	wirev( T3, v33, v34 , 0.05 , Segment1 ) ;	
		// Seiten
	wirev( T3, v29, v31 , 0.05 , Segment1 ) ;	
	wirev( T3, v29, v33 , 0.05 , Segment1 ) ;	
	wirev( T3, v30, v32 , 0.05 , Segment1 ) ;	
	wirev( T3, v30, v34 , 0.05 , Segment1 ) ;	
		// Decke Seiten
	wirev( T3, v31, v33 , 0.05 , Segment1 ) ;	
	wirev( T3, v32, v34 , 0.05 , Segment1 ) ;			
		// Ecken
	wirev( T3, v31, v35 , 0.05 , Segment1 ) ;	
	wirev( T3, v32, v36 , 0.05 , Segment1 ) ;	
	wirev( T3, v33, v37 , 0.05 , Segment1 ) ;	
	wirev( T3, v34, v38 , 0.05 , Segment1 ) ;	
		// Grund
	wirev( T3, v35, v36 , 0.05 , Segment1 ) ;	
	wirev( T3, v37, v38 , 0.05 , Segment1 ) ;	
	wirev( T3, v35, v37 , 0.05 , Segment1 ) ;	
	wirev( T3, v36, v38 , 0.05 , Segment1 ) ;		
	

	
	// House	1

	T3 = translateTransform( vect( 7.0, 20.5, 0.5 ) ) * rotateX( 0 ) * rotateZ(0) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( 0.0, -30.0, 0.5 ) ) * rotateX( 0 ) * rotateZ(0) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( 15.0, -80.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	wirev( T3, v32, v34 , 0.05 , Segment1 ) ;			
		// Ecken
	wirev( T3, v31, v45 , 0.05 , Segment1 ) ;	
	wirev( T3, v32, v46 , 0.05 , Segment1 ) ;	
	wirev( T3, v33, v47 , 0.05 , Segment1 ) ;	
	wirev( T3, v34, v48 , 0.05 , Segment1 ) ;	
		// Grund
	wirev( T3, v45, v46 , 0.05 , Segment1 ) ;	
	wirev( T3, v47, v48 , 0.05 , Segment1 ) ;	
	wirev( T3, v45, v47 , 0.05 , Segment1 ) ;	
	wirev( T3, v46, v48 , 0.05 , Segment1 ) ;		
	
	
		
	// House	3a groß

	T3 = translateTransform( vect( 15.0, -100.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( 15.0, -120.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( 57.0, -150.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( 57.0, -170.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( -45.0, -80.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( -45.0, -100.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( -45.0, -120.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( 63.0, 0.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
	...
	T3 = translateTransform( vect( 63.0, -20.0, 10.5 ) ) * rotateX( 0 ) * rotateZ(90) ;
		// Giebel
	wirev( T3, v29, v30 , 0.05 , Segment1 ) ;		
		// Dachrinnen	
	wirev( T3, v31, v32 , 0.05 , Segment1 ) ;	
